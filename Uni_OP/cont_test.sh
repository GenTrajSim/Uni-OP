...
for i in {1..1}
do
	filename1="../SAVE/MultiPT/${ca_filenmae}/${i}.gro"
	filename2="../SAVE/MultiPT/${ca_filenmae}/${i}.POSCAR"
	filename3="../SAVE/MultiPT/${ca_filenmae}/56.panding.gro"
	filename4="../SAVE/MultiPT/${ca_filenmae}/56.panding.POSCAR"
	filename5="../SAVE/MultiPT/${ca_filenmae}/56.panding.npy"
	filename6="../SAVE/MultiPT/${ca_filenmae}/dist/56.panding.npy"
	filename66="../SAVE/MultiPT/${ca_filenmae}/coord/56.panding.npy"
